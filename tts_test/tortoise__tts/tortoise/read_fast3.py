...
def generate_audio(text, voice, output_path, output_name, preset='standard', model_dir=MODELS_DIR, seed=None, use_deepspeed=False, kv_cache=True, half=True):
    """
...
if __name__ == '__main__':
    ...
    output_file_path = generate_audio(text, args.voice, args.output_path, args.output_name,
                                         args.preset, args.model_dir, args.seed, args.use_deepspeed, args.kv_cache, args.half)
